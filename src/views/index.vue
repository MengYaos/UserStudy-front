                    ...
                    <carousel arrow="always" :autoplay=false :loop="false" v-bind:percentage="percentage" v-on:change="change(arguments,$event)">
                        <carousel-item v-for="items in 66" :key="items" >
                            <el-row type="flex" justify="space-around" style="padding: 0 5%;">
                              <el-col :span="8">
                                <el-image :src="require('../assets/phase1/'+groupId+'_content.png')">
                                </el-image>
                              </el-col>
                                <el-col :span="8">
                                    <el-image :src="require('../assets/phase1/'+groupId+'_style.png')">
                                    </el-image>
                                </el-col>
                                <el-col :span="8">
    ...
    export default {
        ...
        data() {
            return {
                ...
                stylizationLevel: [],
                overallQuality: [],
                renderingSequence: [2, 6, 11, 8, 7, 5, 1, 4, 9, 3, 10],
                marks: {
                    1: '1',
                    2: '2',
                    3: '3',
